...
const contentUpdatedAt = new Date('2026-09-02T00:00:00+09:00');
const policyUpdatedAt = new Date('2026-09-02T00:00:00+09:00');

export default function sitemap(): MetadataRoute.Sitemap {
  const trustPages = ['개인정보처리방침', '이용안내'];
  return [
    { url: siteConfig.domain, lastModified: contentUpdatedAt, changeFrequency: 'weekly', priority: 1 },
    ...pageList.map((page) => ({
